...
type WinAdmin struct {
	...
	Avatar       string `gorm:"column:avatar;type:varchar(512);comment:Avatar | 头像路径" json:"avatar"`                                                                                     // Avatar | 头像路径
	DepartmentID int64  `gorm:"column:department_id;type:bigint unsigned;default:1;comment:Department ID | 部门ID" json:"departmentId"`                                                    // Department ID | 部门ID
}
