...
type WinCoinLog struct {
	...
	OrderID    string          `gorm:"column:order_id;type:varchar(100);comment:订单号" json:"orderId"`                                                                                                                                       // 订单号
