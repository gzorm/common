...
type WinCoinLog struct {
	...
	Category   int64           `gorm:"column:category;type:tinyint;not null;default:1;comment:类型:1-存款 2-提款 3-投注 4-派彩 5-返水 6-佣金 7-活动(奖励) 8-系统调账 9-退款 10-佣金钱包转主账户余额 11-小费  13==转入  14==转出" json:"category"` // 类型:1-存款 2-提款 3-投注 4-派彩 5-返水 6-佣金 7-活动(奖励) 8-系统调账 9-退款 10-佣金钱包转主账户余额 11-小费  13==转入  14==转出
	...
	OrderID    string          `gorm:"column:order_id;type:varchar(64);comment:订单号" json:"orderId"`                                                                                                       // 订单号
